...
const translations: TranslationDict = {
  de: {
    ...
    dashboard: {
      ...
      deleteAllDescription: "Möchten Sie wirklich alle {count} Rechnung(en) löschen? Diese Aktion kann nicht rückgängig gemacht werden. Die Rechnungen werden automatisch nach 10 Minuten gelöscht, um Ihre Privatsphäre zu schützen.",
      deleting: "Lösche...",
  ...
  en: {
    ...
    dashboard: {
      ...
      deleteAllDescription: "Are you sure you want to delete all {count} invoice(s)? This action cannot be undone. Invoices are automatically deleted after 10 minutes to protect your privacy.",
      deleting: "Deleting...",
