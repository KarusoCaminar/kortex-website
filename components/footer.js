      ...
      <footer>
        <div class="footer-container">
          <div>
            ...
            <p style="color:rgba(255,255,255,.85);margin:.6rem 0 .2rem" data-i18n="footer.tagline">KI-gestützte Automatisierung für den deutschen Mittelstand.</p>
          </div>
          <div class="footer-links" aria-labelledby="prod-heading">
            <h3 id="prod-heading" data-i18n="footer.products">Produkte</h3>
            <ul>
              <li><a href="produkte.html#ki-kundensupport" data-i18n="product1.title">KI-Kundensupport</a></li>
              <li><a href="produkte.html#datenverarbeitung" data-i18n="product2.title">Datenverarbeitung</a></li>
              <li><a href="produkte.html#prozessautomatisierung" data-i18n="product3.title">Prozessautomatisierung</a></li>
            </ul>
          </div>
          <div class="footer-links" aria-labelledby="company-heading">
            <h3 id="company-heading" data-i18n="footer.company">Unternehmen</h3>
            <ul>
              <li><a href="ueber-uns.html" data-i18n="nav.ueberuns">Über uns</a></li>
            </ul>
          </div>
          <div class="footer-links" aria-labelledby="legal-heading">
            <h3 id="legal-heading" data-i18n="footer.legal">Rechtliches</h3>
            <ul>
        ...
        <div class="copyright">
          ...
          <p style="margin:0">&copy; ${new Date().getFullYear()} Kortex System. <span data-i18n="footer.copyright">Alle Rechte vorbehalten.</span></p>
        </div>
      </footer>
    `;
    
    // Update footer when language changes
